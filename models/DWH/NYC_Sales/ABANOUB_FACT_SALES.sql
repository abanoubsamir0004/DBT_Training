...
with
    ...
    FACT_SALES AS (
        ...
        LEFT JOIN  DIM_LOCATION 
            ...
            AND NYC_SALES_CLEANEND_SOURCE.NEIGHBORHOOD = DIM_LOCATION.NEIGHBORHOOD 
            AND NYC_SALES_CLEANEND_SOURCE.TAX_BLOCK = DIM_LOCATION.TAX_BLOCK 
            AND NYC_SALES_CLEANEND_SOURCE.TAX_LOT = DIM_LOCATION.TAX_LOT 
        ...
        LEFT JOIN DIM_PROPERTY_AT_PRESENT
            ON NYC_SALES_CLEANEND_SOURCE.BUILDING_CLASS_CATEGORY = DIM_PROPERTY_AT_PRESENT.BUILDING_CLASS_CATEGORY
            AND NYC_SALES_CLEANEND_SOURCE.BUILDING_CLASS_AT_PRESENT = DIM_PROPERTY_AT_PRESENT.BUILDING_CLASS_AT_PRESENT
        ...
        LEFT JOIN DIM_PROPERTY_AT_SALE
            ON  NYC_SALES_CLEANEND_SOURCE.BUILDING_CLASS_AT_TIME_OF_SALE = DIM_PROPERTY_AT_SALE.BUILDING_CLASS_AT_TIME_OF_SALE
